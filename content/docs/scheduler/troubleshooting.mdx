...
Start with `php vortos scheduler:doctor`. It runs 11 health checks (C1–C11) and reports exactly what is wrong, with a remediation hint for each failure. Most common problems are immediately visible there.
