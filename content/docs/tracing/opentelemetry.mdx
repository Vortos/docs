...
|---|---|---|
| Grafana Tempo | `http://tempo:4318/v1/traces` | [Tempo setup](/docs/observability/tempo) |
| Jaeger | `http://jaeger:4318/v1/traces` | [Jaeger setup](/docs/observability/jaeger) |
| Datadog Agent | `http://datadog-agent:4318/v1/traces` | [Datadog setup](/docs/observability/datadog) |
| AWS X-Ray | Via OpenTelemetry Collector | [OTel Collector docs](https://opentelemetry.io/docs/collector/) |
| Google Cloud Trace | Via OpenTelemetry Collector | [OTel Collector docs](https://opentelemetry.io/docs/collector/) |
