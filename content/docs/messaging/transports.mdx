---
title: Transports
description: Define Kafka topics, connection settings, and security configuration using Vortos' fluent transport API.
---
...
<Callout type="info" title="Startup Validation">
