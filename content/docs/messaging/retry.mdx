...
```bash
php bin/console vortos:dlq:replay user.events
```

Options:

```bash
php bin/console vortos:dlq:replay user.events --limit=100
php bin/console vortos:dlq:replay user.events --event-class="App\User\Domain\Event\UserRegisteredEvent"
php bin/console vortos:dlq:replay user.events --from-date="2026-01-01" --to-date="2026-01-31"
```
