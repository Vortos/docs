...
php bin/console vortos:outbox:replay --event-class="App\\User\\Domain\\Event\\UserCreatedEvent"
...
php bin/console vortos:outbox:replay --latest --limit=10 --transport=user.events --dry-run
```
