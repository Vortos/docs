...
The package includes `Vortos\Ses\Testing\SesMailerFake` for assertions.

## Functional Test Pattern

```php
use Vortos\Ses\Testing\SesMailerFake;
...
```bash
php bin/console vortos:worker:install --worker=ses-outbox-relay --dry-run
```
