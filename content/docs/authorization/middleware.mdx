---
title: Middleware
description: How AuthorizationMiddleware enforces #[RequiresPermission] on controllers at priority 3 — compile-time route map, resource loading, and response shapes.
---
