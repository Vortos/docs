...
<Cards>
  <Card title="SCIM Provisioning & SSO" href="/docs/auth/scim" description="RFC 7643/7644 user and group provisioning, tenant-scoped, with IdP group-to-role mapping." />
  <Card title="Resilience" href="/docs/auth/resilience" description="Fail-open/fail-closed modes and circuit breakers for when Redis goes away." />
  <Card title="Token Freshness" href="/docs/auth/token-freshness" description="The global revocation epoch — the emergency kill-every-session lever." />
</Cards>
