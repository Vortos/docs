...
|---|---|---|
| PostgreSQL | Dedicated `vortos` schema | `vortos.user_roles` |
| MySQL, SQLite, SQL Server, Oracle | `vortos_` prefix | `vortos_user_roles` |
...
<Callout type="info" title="Container parameter">
