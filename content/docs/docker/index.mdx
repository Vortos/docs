...
Files are copied from the package's `stubs/` directory into your project root. Existing files are overwritten.
...
<Callout type="info" title="Re-publishing Overwrites Files">
Running `vortos:docker:publish` again overwrites existing Docker files with the latest stubs from the package. If you have customised your Docker files, keep them in version control and review diffs after re-publishing.
</Callout>
