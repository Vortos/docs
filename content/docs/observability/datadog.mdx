---
title: Datadog
description: Send Vortos metrics via OpenTelemetry OTLP or DogStatsD and traces via OpenTelemetry to Datadog — Agent setup and full APM configuration.
---
...
<Callout type="info" title="OTLP lifecycle">
