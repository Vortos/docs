---
title: Make
description: 24 code generation commands that scaffold your entire application — domain, CQRS, messaging, HTTP, persistence, and authorization — from a single CLI.
---
...
<Cards>
  <Card title="Domain" href="/docs/make/domain" description="context, aggregate, entity, value-object, domain-event, domain-error, domain-service." />
